...
public class CacheTest {
	public static void main(String[] args) throws Exception {
		...
		SnowFlakeUUIDService snowFlakeUUIDService = (SnowFlakeUUIDService) classPathXmlApplicationContext
				.getBean("snowFlakeUUIDService");
	...
	public static OrderService getOrderService(ClassPathXmlApplicationContext classPathXmlApplicationContext)
		...
		EntityServiceProxyFactory entityServiceProxyFactory = (EntityServiceProxyFactory) classPathXmlApplicationContext
				.getBean("entityServiceProxyFactory");
